...
3. Watch all 3 run in parallel
    ...
    ![images](images/github-hosted(ubuntu).png)

    ![images](images/github-hosted(windows).png)

    ![images](images/github-hosted(mac).png)
...
1. On the `ubuntu-latest` runner, run a step that prints:
   ...
   - Git version
     ...
     ![images](images/preinstalled.png)


     
2. Look up the GitHub docs for the full list of pre-installed software on `ubuntu-latest`

    [pre-installed](workflows/ub-preinstall-software.yml)
...
4. Trigger it and watch it run on your own hardware
   ...
   [workflows](workflows/self-hosted.ym)
